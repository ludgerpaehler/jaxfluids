    ...
    def reconstruct_xi(
        ...
        beta_0 = (
            ...
            * (
            ...
            + buffer[s1_[1]]
            * (7043 * buffer[s1_[1]] - 17246 * buffer[s1_[2]] + 7042 * buffer[s1_[3]])
        ...
        beta_1 = (
            ...
            * (
            ...
            + buffer[s1_[2]]
            * (2843 * buffer[s1_[2]] - 5966 * buffer[s1_[3]] + 1922 * buffer[s1_[4]])
        ...
        beta_2 = (
            ...
            * (
            ...
            + buffer[s1_[3]]
            * (3443 * buffer[s1_[3]] - 5966 * buffer[s1_[4]] + 1602 * buffer[s1_[5]])
        ...
        beta_3 = (
            ...
            * (
            ...
            + buffer[s1_[4]]
            * (11003 * buffer[s1_[4]] - 17246 * buffer[s1_[5]] + 4642 * buffer[s1_[6]])
